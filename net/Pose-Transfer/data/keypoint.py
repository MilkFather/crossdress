...
class KeyDataset(BaseDataset):
    def initialize(self, opt):
        ...
        # For Market-1501
        self.folder_names = {"train": "bounding_box_train", "test": "bounding_box_test"}
        # For DeepFashion
        #self.folder_names = {"train": "train", "test": "test"}
        self.dir_P = os.path.join(opt.dataroot, self.folder_names[opt.phase]) #person images
        self.dir_K = os.path.join(opt.dataroot, self.folder_names[opt.phase] + 'K') #keypoints
